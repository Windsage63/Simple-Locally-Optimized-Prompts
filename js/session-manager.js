class SessionManager {
    ...
    _generateSessionName(promptInput) {
    ...
    saveSession(session) {
        ...
        if (session.name === 'New Session' && session.promptInput) {
            session.name = this._generateSessionName(session.promptInput);
        } else if (session.promptInput && session.name !== this._generateSessionName(session.promptInput)) {
